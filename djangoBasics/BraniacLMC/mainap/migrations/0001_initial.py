...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Courses',
            fields=[
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='mainap.basemodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Edited')),
                ('deleted', models.BooleanField(default=False)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainap.courses')),
            ],
            options={
                'ordering': ('course', 'num'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted', models.BooleanField(default=False)),
                ('course', models.ManyToManyField(to='mainap.courses')),
            ],
            options={
